(() => ({
  ...
  jsx: (() => {
    ...
    return <div className="container" id="container"><button id='1' onClick={buttonClick1}>Add field</button>
    <button id='2' onClick={buttonClick2} style={{display: 'none'}}>Remove field</button></div>;
  })(),
  styles: () => () => ({
    root: {},
  }),
